      ...
      <div className="container">
        <div className="left-section">
          <div
            ...
            style={{ color: "#f5f6fa", fontFamily: "fira sans, sans-serif" }}
          >
            <h1 className="heading">404</h1>
            <p className="subheading">
              Looks like the page you were looking for is no longer here.
            </p>
            {/* <Link to={pathRoot} className="subnav_link"> */}
            <Button className="m-auto subnav_link" href={pathRoot}>
              Go Back
            </Button>
            {/* </Link> */}
          </div>
